/*  7 Jun 2023 15:45
Simple specialized class for handling input from PineTime sensors.
...
PineTime {
	classvar <>sensormsg = '/pinetime/data';
	...
	*makeSmoothForwarder {
		...
		if (Server.default.serverRunning.not) {
			^"PineTime cannot start minibesmooth synth. Boot the default server".postln;
		};
		"Starting PineTime smooth synth".postln;
		{
			var sensorlags;
