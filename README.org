...
*** 25 Jan 2021 18:30 Radical simplification of currentEnvironment usage

**** Preliminaries: A New ProxySpace-like class and its api
...
#+begin_src sclang
a = Mediator().push; // initialize the system with this
