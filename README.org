...
** Issues Addressed: Name, State, Communication, Coordination, Templates
   :PROPERTIES:
...
*** Templates: Useful patterns for constructing objects

In the form of methods that return these templates.
...
3 cases where we need to save process state: 

- Synths :: Name of synthdef or source function + argument / target state
- Routine :: source function
