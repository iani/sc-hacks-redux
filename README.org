...
- Add an audio bus to player, initialized to a default number of channels (2, can be overriden by argument or method). (This is similar to NodeProxy). 
